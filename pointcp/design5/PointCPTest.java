...
public class PointCPTest
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			{
				point = new PointC( Double.valueOf(args[1]).doubleValue(), 
	...
	private static PointCP getInput() throws IOException
	{
		...
		char typeCoord = 'A'; // Temporary default, to be set to P or C
		double a = 0.0;
		double b = 0.0;
			...
			while (!(isOK))
			{
				...
				try
				{
					if (i == 0) // First argument -- type of coordinates
					{
						...
						{
							typeCoord = theInput.toUpperCase().charAt(0);
						}
					}
					else  // Second and third arguments
					{
